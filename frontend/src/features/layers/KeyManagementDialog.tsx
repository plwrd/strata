          ...
          <div className="dialog__body">
            {tab === "password" && (
              <>
                <p className="dialog__note">
                  ...
                  large layer — and it does <strong>not</strong> revoke anyone
                  ...
                  <button
                    ...
                    onClick={() => {
                      void (async () => {
                        ...
                        setError(null);
                        try {
                          await forgetSavedPassword(layer.id);
                          setBusy(false);
                          setDone(
                            "The saved password was removed from this device.",
                          );
                        } catch (cause) {
                          fail(
                            cause,
            ...
            {tab === "rotate" && (
              <>
                ...
                <p className="dialog__note">
                  A crash mid-rotation is resumed from a journal on the next
                  unlock. Back the layer up first anyway.
                </p>
                <p className="dialog__note">
            ...
            {done && (
              <p
                className="composer__status composer__status--ok"
                role="status"
              >
                {done}
              </p>
