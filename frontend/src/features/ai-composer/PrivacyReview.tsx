      ...
      >
        ...
        >
          <h2 id="privacy-title" className="dialog__title">
            <span className="tag tag--danger">Private content</span> Review
            before exporting
          </h2>
          ...
          <div id="privacy-body" className="dialog__body">
            <p>
              ...
              <strong>{plan.private_layer_names.length}</strong> private
              layer(s): {plan.private_layer_names.join(", ")}.
            </p>
            ...
            <p className="mono dialog__facts">
              ...
              {plan.estimated_tokens.toLocaleString()} &nbsp;·&nbsp; data
              leaving this device: no (files are written locally)
            </p>
